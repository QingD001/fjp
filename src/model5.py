...
class TextCNN(nn.Module):
    def __init__(self, vocab_size, embed_dim=128, num_filters=128, kernel_sizes=(2, 3, 4), dropout=0.3):
        super().__init__()
...
def train(df: pd.DataFrame, y: pd.Series, epochs: int = 10, batch_size: int = 64) -> CNNWrapper:
    ...
    return CNNWrapper(model, word2idx, max_len, device)
